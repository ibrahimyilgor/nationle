...
const LoseModal = ({ country, handleClose, open, datee, guesses }) => {
  ...
  useEffect(() => {
    if (open) {
      ...
      setMapData({
        [guesses[0].code ?? "XXX"]:
          country?.alpha2.toUpperCase() === guesses[0].code ? 9000 : 500,
        [guesses[1].code ?? "XXX"]:
          country?.alpha2.toUpperCase() === guesses[1].code ? 9000 : 500,
        [guesses[2].code ?? "XXX"]:
          country?.alpha2.toUpperCase() === guesses[2].code ? 9000 : 500,
        [guesses[3].code ?? "XXX"]:
          country?.alpha2.toUpperCase() === guesses[3].code ? 9000 : 500,
        [guesses[4].code ?? "XXX"]:
          country?.alpha2.toUpperCase() === guesses[4].code ? 9000 : 500,
        [guesses[5].code ?? "XXX"]:
          country?.alpha2.toUpperCase() === guesses[5].code ? 9000 : 500,
      });
